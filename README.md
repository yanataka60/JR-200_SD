...
### 2025.2.26 PIOに6821を使ったRev2.1ではPIOアクセス時の画面ノイズが発生しないので6821版を正式版とし、8255版は8255フォルダに移動しました。なお、開発に使用した2台のJR-200では6821版、8255版ともに安定動作していますが、8255版は動作不安定であると報告された機体でも6821版は安定動作しているとの動作報告がありました。
